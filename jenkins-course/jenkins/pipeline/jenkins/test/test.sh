...
docker run --rm -v /root/.m2:/root/.m2 -v "/home/curro/gdrive/src/fun/docker-projects/jenkins-course/jenkins/pipeline/simple-java-maven-app:/app" -w /app maven:3-alpine "${@}"
